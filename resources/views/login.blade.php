	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="index.html">Bee-Pro</a></h1>
			</div>
	...
	<div class="navigation-agileits">
		<div class="container">
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs" style="margin-left:10%">
											...
											<div class="row">
												<div class="multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6>All Make Up</h6>
														<li><a href="makeup-face.html">Face</a></li>
														<li><a href="makeup-lips.html">Lips</a></li>
														<li><a href="makeup-eyes.html">Eyes</a></li>
														<li><a href="makeup-kits.html"> Make Up Kits </a></li>
													</ul>
												</div>	
											</div>
										</ul>
										...
										<ul class="dropdown-menu multi-column columns-3">
											<div class="row">
												<div class="multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6>All Skin Care</h6>
														<li><a href="skincare-cleanser.html">Cleanser</a></li>
														<li><a href="skincare-moisturizer.html">Moisturizer</a></li>
														<li><a href="skincare-lip.html">Lip Care</a></li>
													</ul>
												</div>		
											</div>
										</ul>
											...
											<div class="row">
												<div class="multi-gd-img">
													<ul class="multi-column-dropdown">
														...
														<li><a href="personalcare-bath.html">Bath</a></li>
														<li><a href="personalcare-body.html">Body</a></li>
														<li><a href="personalcare-hands-feets.html">Hands & Feet</a></li>
													</ul>
												</div>
